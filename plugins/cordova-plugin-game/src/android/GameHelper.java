...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onStart(Activity act) {
        ...
        /* workaround for cancel sign-in bug */
        if (mSignInCancelled) {
        ...
        if (mSignInFailureReason != null) {
            ...
            switch (actResp) {
                case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
                    return GameHelperUtils.R_APP_MISCONFIGURED;
                case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
                    return GameHelperUtils.R_SIGN_IN_FAILED;
                case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
                    return GameHelperUtils.R_LICENSE_FAILED;
                default:
                    return GameHelperUtils.R_COMM_ERROR;
            }
        }
        return -1;
    }
